...
public class Instructor implements User {
    ...
    public Instructor(String name) {
        ...
        this.interests = Arrays.asList(NotificationType.COURSE_UPDATE, NotificationType.SYSTEM_ALERT);
    }

    @Override
    public void update(NotificationEvent event) {
        String message = "Giảng viên " + name + " nhận thông báo chi tiết: " + event.getMessage();
